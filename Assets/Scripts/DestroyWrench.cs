...
public class DestroyWrench : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Keypad1) && isClose && playerInv.envanter[0] == "Wrench")
        {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad2) && isClose && playerInv.envanter[1]== "Wrench")
        {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad3) && isClose && playerInv.envanter[2] == "Wrench")
        {
