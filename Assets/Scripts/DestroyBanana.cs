...
public class DestroyBanana : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Keypad1) && isClose && playerInv.envanter[0] == "Banana")
        {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad2) && isClose && playerInv.envanter[1]=="Banana")
        {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad3) && isClose && playerInv.envanter[2] == "Banana")
        {
